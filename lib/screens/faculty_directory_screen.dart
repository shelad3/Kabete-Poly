...
class _FacultyDirectoryScreenState extends State<FacultyDirectoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Faculty & Staff Directory')),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Only teachers and officials can view the directory.',
  ...
  Widget _buildDirectory() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        List<Map<String, dynamic>> allDocs = (snapshot.data?.docs ?? [])
        ...
        var filtered = allDocs.where((d) {
          ...
          final matchesDept =
              ...
              d['designation'] == _selectedDepartment;
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final String designation =
                            data['designation'] ?? 'Department Member';
  ...
  Widget _buildFilterChip(String label, String? value) {
    ...
    return Padding(
      ...
      child: FilterChip(
        ...
        selected: selected,
        onSelected: (_) =>
            setState(() => _selectedDepartment = selected ? null : value),
      ),
    );
  }
}
